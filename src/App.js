...
const App = () => {
  ...
  const getCards = () => {
    switch (selectedTab) {
      ...
      case "tab2":
        return [
          "https://media.gettyimages.com/id/1477654940/photo/dusk-on-the-streets-of-mumbai-india.jpg?s=612x612&w=gi&k=20&c=ZPDDlzwBWYFXRVbY2rDm3E3yNnWdTaH9xZfCfcW45lc=",
          "https://letsenhance.io/static/8f5e523ee6b2479e26ecc91b9c25261e/1015f/MainAfter.jpg",
          "https://cdn.pixabay.com/photo/2016/05/03/20/01/mumbai-1370023_640.jpg",
          "https://cdn.pixabay.com/photo/2016/05/03/20/01/mumbai-1370023_640.jpg",
        ];
    ...
    <div className="app">
      <div className="top-head">
        <div className="top-title">
          <div className="arrow">
            ...
            starchild2.0_by_krissannba...
          </div>{" "}
          <div className="share" onClick={() => setIsModalOpen(true)}>
            <ShareIcon />
          </div>
        </div>
      </div>
      <div className="profile-header">
        ...
        <div className="profile-info">
          ...
          <a href="https://www.instagram.com/krissannb/">
      ...
      <BottomNav
        ...
        setSelectedTab={setSelectedBottomTab}
        setPopup={setPopup}
      />
      <Modal
        isOpen={isModalOpen}
